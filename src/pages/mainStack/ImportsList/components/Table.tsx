    ...
    <>
      <TableContainer ref={containerRef}>
        <StyledTable>
          ...
          <tbody>
            {imports.map((order) => (
              <Tr key={order.id} onClick={() => onClickImport(order.id)}>
                <Td>
                ...
                <Td>
                  <MonospaceText>{order.sourceFileName}</MonospaceText>
                </Td>
                <Td>
                  <Amount>{order.orderCount?.toLocaleString()}</Amount>
                </Td>
              </Tr>
            ))}
          </tbody>
